...
class Fish {
  ...
  availableRangeDuring(r) {
    ...
    var m = +r.start();
	if (parseInt(this.startHour)!=this.startHour) {m=dateFns.utc.setMinutes(m, 30)}
    if (this.endHour < this.startHour) {
      ...
      if (dateFns.utc.getHours(m) < this.endHour) {//console.log(dateFns.utc.setHours(m, 18));console.log(dateFns.utc.setHours(m, 18.9));
